...
const products = [
  {
    ...
    status: "On call",
    metric: "42 conversations",
    rows: [
      ["Intent detected", "High"],
      ["Appointment", "Booked · Thu 3:00"],
      ["Synced to CRM", "Done"],
    ],
  ...
  },
  {
    ...
    status: "Sourcing live",
    metric: "128 qualified leads",
    rows: [
      ["Lead quality", "92 / 100"],
      ["Best channel", "Paid search"],
      ["CRM delivery", "128 synced"],
    ],
