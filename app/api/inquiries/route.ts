...
<html>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #E5E7EB;border-radius:12px;">
                  <tr>
                    <td style="padding:20px 22px;">
                      <p style="margin:0;font-family:Helvetica,Arial,sans-serif;font-size:14px;font-weight:700;color:#0D0D0D;line-height:1.4;">Help us prepare - two minutes</p>
                      <p style="margin:6px 0 14px;font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#6B7280;line-height:1.6;">A quick, multiple-choice questionnaire about your business${company ? ` (${escapeHtml(company)})` : ""} so our first conversation goes straight into strategy.</p>
                      <a href="https://www.vistrow.com/client-discovery" style="display:inline-block;background:#0D0D0D;color:#FFFFFF;font-family:Helvetica,Arial,sans-serif;font-size:13px;font-weight:700;text-decoration:none;padding:10px 18px;border-radius:999px;">Answer 10 quick questions</a>
                    </td>
                  </tr>
                </table>
              </td>
  ...
  const text = `${isAudit ? "GROWTH AUDIT REQUESTED" : "MESSAGE RECEIVED"}\n\n${introPlain}\n\n${stepsText}\n\nHelp us prepare - two minutes: answer a quick, multiple-choice questionnaire about your business so our first conversation goes straight into strategy.\nhttps://www.vistrow.com/client-discovery\n\nVisit https://www.vistrow.com\n\n- Vistrow Technologies`;
