...
export const businessAutomationServices: Record<string, ServiceContent> = {
  ...
  "ai-voice-calling": {
    ...
    eyebrow: "Business Automation",
    subtitle:
      "AI voice agents that call and qualify new leads within seconds, answer common questions, and book appointments straight into your calendar—around the clock.",
    metaTitle: "AI Voice Calling",
    metaDescription:
      "AI voice agents that respond to leads in seconds, qualify by phone 24/7, and book appointments into your calendar.",
    problem: {
      title: "Speed to lead decides who wins.",
      body: "The first business to respond usually wins the deal—but no team can call every lead instantly, all day. That's where response time quietly kills conversion.",
      points: [
        "Leads go cold before anyone calls",
        "After-hours enquiries missed entirely",
        "Reps spending time on unqualified calls",
        "Inconsistent qualification and notes",
      ],
    },
    outcomes: [
      { stat: "Seconds", label: "To first call", body: "AI reaches new leads the moment they arrive." },
      { stat: "24/7", label: "Coverage", body: "Nights, weekends, and peak volume handled." },
      { stat: "Qualified", label: "Handoffs", body: "Reps only talk to ready, scored leads." },
    ],
    included: [
      "Voice agent design and scripting",
      "Lead-trigger integration",
      "Qualification logic and scoring",
      "Calendar and booking integration",
      "CRM logging and notes",
      "Human handoff rules",
      "Call recording and transcripts",
      "Performance monitoring",
    ],
    steps: [
      { title: "Audit", body: "Map your lead flow, qualification, and calendar." },
      { title: "Plan", body: "Design the call flow, questions, and handoffs." },
      { title: "Build", body: "Deploy the agent connected to CRM and calendar." },
      { title: "Improve", body: "Refine scripts and logic on real call data." },
    ],
    tools: ["Vistrow Voice", "Twilio", "HubSpot", "Google Calendar", "Cal.com", "Zapier"],
    faqs: [
      { q: "Will callers know it's AI?", a: "We design for transparency and a natural experience. The goal is fast, helpful qualification—handing off to a human when it matters." },
      { q: "What happens for complex questions?", a: "The agent follows handoff rules to route to a human or book a call, so nothing important is lost." },
      { q: "Does it work with our CRM and calendar?", a: "Yes—calls, notes, and bookings sync into your CRM and calendar automatically." },
    ],
  },
