...
- Marketing automation / creative strategy: a flowchart of connected blank boxes representing a workflow, linked by arrows; a set of blank ad-creative thumbnail rectangles laid out like a mood board; a chat-bubble sequence with blank bubble shapes showing an automated message thread (generic app, no real logo).
